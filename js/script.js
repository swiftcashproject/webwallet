  ...
  if (window.ethereum) {
    try {
      ...
      await window.ethereum.request({
        ...
        params: [{ chainId: EVMCHAININFO[swapServer].chainIdVar }], // chainId must be in hexadecimal numbers
      });
      //   detectChainId()
...
const tokenabi = [{ "inputs": [{ "internalType": "address", "name": "_multisign", "type": "address" }], "stateMutability": "nonpayable", "type": "constructor" }, { "anonymous": false, "inputs": [{ "indexed": true, "internalType": "address", "name": "owner", "type": "address" }, { "indexed": true, "internalType": "address", "name": "spender", "type": "address" }, { "indexed": false, "internalType": "uint256", "name": "value", "type": "uint256" }], "name": "Approval", "type": "event" }, { "anonymous": false, "inputs": [{ "indexed": false, "internalType": "uint256", "name": "timestamp", "type": "uint256" }, { "indexed": false, "internalType": "address", "name": "from", "type": "address" }, { "indexed": false, "internalType": "uint256", "name": "amount", "type": "uint256" }, { "indexed": false, "internalType": "string", "name": "to", "type": "string" }], "name": "BurnLog", "type": "event" }, { "anonymous": false, "inputs": [{ "indexed": false, "internalType": "uint256", "name": "timestamp", "type": "uint256" }, { "indexed": false, "internalType": "uint256", "name": "amount", "type": "uint256" }, { "indexed": false, "internalType": "address", "name": "to", "type": "address" }], "name": "MintLog", "type": "event" }, { "anonymous": false, "inputs": [{ "indexed": true, "internalType": "address", "name": "from", "type": "address" }, { "indexed": true, "internalType": "address", "name": "to", "type": "address" }, { "indexed": false, "internalType": "uint256", "name": "value", "type": "uint256" }], "name": "Transfer", "type": "event" }, { "inputs": [{ "internalType": "address", "name": "owner", "type": "address" }, { "internalType": "address", "name": "spender", "type": "address" }], "name": "allowance", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "spender", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "approve", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "account", "type": "address" }], "name": "balanceOf", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" }, { "inputs": [{ "internalType": "uint256", "name": "_amount", "type": "uint256" }, { "internalType": "string", "name": "_toNativeChainAddress", "type": "string" }], "name": "bridgeToNative", "outputs": [], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [{ "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "burn", "outputs": [], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "account", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "burnFrom", "outputs": [], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "_multisign", "type": "address" }], "name": "changeMultisignContract", "outputs": [], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [], "name": "decimals", "outputs": [{ "internalType": "uint8", "name": "", "type": "uint8" }], "stateMutability": "view", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "spender", "type": "address" }, { "internalType": "uint256", "name": "subtractedValue", "type": "uint256" }], "name": "decreaseAllowance", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "spender", "type": "address" }, { "internalType": "uint256", "name": "addedValue", "type": "uint256" }], "name": "increaseAllowance", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "_recipient", "type": "address" }, { "internalType": "uint256", "name": "_amount", "type": "uint256" }], "name": "mint", "outputs": [], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [], "name": "name", "outputs": [{ "internalType": "string", "name": "", "type": "string" }], "stateMutability": "view", "type": "function" }, { "inputs": [], "name": "symbol", "outputs": [{ "internalType": "string", "name": "", "type": "string" }], "stateMutability": "view", "type": "function" }, { "inputs": [], "name": "totalSupply", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "to", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "transfer", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "nonpayable", "type": "function" }, { "inputs": [{ "internalType": "address", "name": "from", "type": "address" }, { "internalType": "address", "name": "to", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "transferFrom", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "nonpayable", "type": "function" }]
...
function alertSuccess(t, m) {
  swal.fire({ icon: "success", title: t, text: m });
}
...
$(function () {
  $.ajax({
    ...
    $("#jackpot").text(result.lotteryjackpot.toLocaleString("en", { minimumFractionDigits: 2, maximumFractionDigits: 2, }));
...
function toCustomFixed(number) {
  return number.toLocaleString(undefined, { minimumFractionDigits: PARAMS[CURRENT_COIN].precision, maximumFractionDigits: PARAMS[CURRENT_COIN].precision });
}
...
function openQrModal(param) {
  qrIdToFill = param;
  scanner = new Instascan.Scanner({ mirror: false, video: document.getElementById('qrScannerPreview') });
...
function login() {
  ...
  if ($('ul.error-list').html() != "" || $('span.password-verdict').html() != "Very Strong") { alertError("You need a stronger password!", "Try choosing a longer password. At least 14 characters recommended, with both uppercase and lowercase characters as well as numbers and special characters."); return; }
  ...
  if ($('#privlogintoggle').attr('aria-pressed') == "true") {
    ...
    if (!success) { alertError("Invalid Private Key!"); return; }
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      if (txid && (typeof txid === 'string' || txid instanceof String)) {
        ...
        utxos.push({ [p1]: txid, [p2]: 0, [p3]: valueMinusFee * PARAMS[CURRENT_COIN].unspentDivision });
...
function modifyTheChangeAddress() {
  Swal.fire({
    ...
    if (result.isConfirmed)
      ...
      } catch (e) { alertError("Please enter a valid address!"); return; }
  });
}
...
function donate() {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      } else { alertError("Please enter a valid amount!"); }
    }
  });
}
...
function changeTheFee() {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      } else { alertError("Please enter a valid fee!"); }
    }
  });
}
...
function swapTokens(server) {
  const sOptions = { "D": "Deposit", "W": "Withdraw" };
  swal.fire({
...
function spendf() {
  ...
  if (balance < FEE || SWIFT(amount + FEE) > balance) { alertError("Insufficient funds!", "Minimum network fee is " + SWIFT(FEE) + " " + CURRENT_COIN + "."); return; }
  ...
  if (address != "Lottery" && !address.startsWith("HODL") && !isSwapping) {
    ...
    alertError("Swap, Lottery and/or HODL transactions only work with SWIFT!"); return;
